	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="close" data-dismiss="modal" style="position: absolute; right: 15px; top: 15px; font-size: 28px; font-weight: 700; line-height: 1; color: #000; text-shadow: 0 1px 0 #fff; opacity: .5; background: transparent; border: 0; cursor: pointer;">&times;</button>
			</div>
...
<script>
	var nextUserList;
        ...
        $('#nextUserModal').on('click', '.close, [data-dismiss="modal"]', function() {
