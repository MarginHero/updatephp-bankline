@include('_partials.header_content',['breadcrumb'=>['Pending task','Fee Setup Detail']])
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="box-body">
                                ...
                                <table id="listDelete" class="table table-bordered table-striped dataTable" border="2" cellpadding="2"
...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#list').DataTable({
         ...
         oTableDelete = $('#listDelete').DataTable({
            "paging" : false,
            "ordering" : false,
            "info": false,
            "destroy": true,
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $.each(detail, function (idx, obj){
                        ...
                        if(result.details.action == 'DELETE'){
                            oTableDelete.row.add([
                                serviceName,
                                obj.serviceChargeName,
                                obj.currencyCode,
                                obj.value
