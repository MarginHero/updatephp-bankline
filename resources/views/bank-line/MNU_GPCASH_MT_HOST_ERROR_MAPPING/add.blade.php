                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="name" name="name" class="form-control state_edit" autocomplete="off" value="" maxlength="200" data-error="This field is required." required>
                                    <div class="help-block with-errors"></div>
						...
						<div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="nameId" name="nameId" class="form-control state_edit" autocomplete="off" value="" maxlength="200" data-error="This field is required." required>
                                    <div class="help-block with-errors"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#confirm').on('click', function () {
            ...
            if($('#nameId').val().trim() === '') {
                var $formGroup = $('#nameId').closest('.row');
                $formGroup.addClass('has-error');
