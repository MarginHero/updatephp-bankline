...
<script>
    ...
    $(document).ready(function () {
        ...
        if (window.searchParam) {
            $('#corpId').val(window.searchParam.corporateId).change();
            ...
            "columnDefs": [
                {
                    ...
                    render: function ( data, type, full, meta ) {
                        return '<a href="javascript:void(0)" data-cifid="'+data.cifId+'" data-code="'+data.corporateId+'">'+data.corporateId + ' - ' + data.corporateName +'</a>';
                    },
                    orderable: true
                },
                {
