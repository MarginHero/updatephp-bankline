            ...
            "columnDefs": [
               {
                ...
                },
                {
                    ...
                    "render": function ( data, type, row ) {
                        if(data=="Y"){
                            return '<input type="hidden" id="oldIsAllowInquiry" value="'+data+'"><span class="label label-success">&nbsp;&nbsp;YES&nbsp;&nbsp;</span>'
                        }else{
                            return '<input type="hidden" id="oldIsAllowInquiry" value="'+data+'"><span class="label label-danger">&nbsp;&nbsp;NO&nbsp;&nbsp;</span>'
                        }
                    }
                },
                {
                    ...
                    "render": function ( data, type, row ) {
                        if(data=="Y"){
                            return '<input type="hidden" id="oldIsAllowDebit" value="'+data+'"><span class="label label-success">&nbsp;&nbsp;YES&nbsp;&nbsp;</span>'
                        }else{
                            return '<input type="hidden" id="oldIsAllowDebit" value="'+data+'"><span class="label label-danger">&nbsp;&nbsp;NO&nbsp;&nbsp;</span>'
                        }
                    }
                },
                {
                    ...
                    "render": function ( data, type, row ) {
                        if(data=="Y"){
                            return '<input type="hidden" id="oldIsAllowCredit" value="'+data+'"><span class="label label-success">&nbsp;&nbsp;YES&nbsp;&nbsp;</span>'
                        }else{
                            return '<input type="hidden" id="oldIsAllowCredit" value="'+data+'"><span class="label label-danger">&nbsp;&nbsp;NO&nbsp;&nbsp;</span>'
                        }
                    }
                },
                {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(detail){
                    ...
                    var detail = result.oldValue.details.accountList;
                    $('#old_code_1').text(result.details.corporateId+' - '+result.details.name);
                    $('#old_cifid').text(result.details.cifId);
                    old_oTable.clear();
                    if(detail){
                        $.each(detail, function (idx, obj){
                            old_oTable.row.add([
