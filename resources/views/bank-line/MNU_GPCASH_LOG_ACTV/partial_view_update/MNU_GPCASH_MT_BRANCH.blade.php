                 ...
                 if (result.status=="200") {
                    ...
                    $('#address3').text(detail.address3);
                     if(detail.type == 'branch'){
                         $('#type').text('Branch');
                     }else if( detail.type == 'sub-branch'){
                         $('#type').text('Sub Branch');
                     }
                     ...
                     $('#old_contact').text(detail.contactName);
                     $('#old_email').text(detail.email);
                     $('#old_address1').text(detail.address1);
                     $('#old_address2').text(detail.address2);
                     $('#old_address3').text(detail.address3);
                     if(detail.type == 'branch'){
                         $('#old_type').text('Branch');
                     }else if( detail.type == 'sub-branch'){
                         $('#old_type').text('Sub Branch');
                     }
