            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">CIF</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Corporate Code</label>
                                <div class="col-md-6">
                ...
                <div class="box-body state_edit">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"><strong>Main Account&ast;</strong></label>
                                <div class="col-md-5">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"><strong>Product&ast;</strong></label>
                                <div class="col-md-5">
