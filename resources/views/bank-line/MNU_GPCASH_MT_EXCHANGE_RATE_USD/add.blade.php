...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#trxBuyRate").keydown(function (event) {
            var trxBuyRateBlock = $("#trxBuyRateBlock");
            trxBuyRateBlock.removeClass('has-error');
            trxBuyRateBlock.find('.with-errors').html('');
        ...
        $("#trxSellRate").keydown(function (event) {
            var trxSellRateBlock = $("#trxSellRateBlock");
            trxSellRateBlock.removeClass('has-error');
            trxSellRateBlock.find('.with-errors').html('');
            if (event.shiftKey == true) {
                event.preventDefault();
            }
    ...
    function checkDecimalValid() {
        var valid=true;
        var sellRate = $('#trxSellRate').val().toString().substring(0,1);
        var trxSellRateBlock = $("#trxSellRateBlock");
        trxSellRateBlock.removeClass('has-error');
        trxSellRateBlock.find('.with-errors').html('');
        if(sellRate == '.'){
            $('#trxSellRate').val('0'+$('#trxSellRate').val())
        }
        var buyRate = $('#trxBuyRate').val().toString().substring(0,1);
        var trxBuyRateBlock = $("#trxBuyRateBlock");
        trxBuyRateBlock.removeClass('has-error');
        trxBuyRateBlock.find('.with-errors').html('');
        if(buyRate == '.'){
            $('#trxBuyRate').val('0'+$('#trxBuyRate').val())
        }
