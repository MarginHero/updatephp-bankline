@include('_partials.header_content',['breadcrumb'=>['Pending task','Exchange Rate (USD) Detail']])
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $('#trxBuyRate').text(detail.trxBuyRateFormatted?detail.trxBuyRateFormatted:detail.trxBuyRate);
                    $('#trxSellRate').text(detail.trxSellRateFormatted?detail.trxSellRateFormatted:detail.trxSellRate);
