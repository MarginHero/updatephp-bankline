            ...
            <div class="modal-body">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">L/C Bank Reference No.</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">L/C Issue Date</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Invoice No.</label>
                                <div class="col-md-6">
