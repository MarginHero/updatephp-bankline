				...
				<div class="box">              
					...
					<div class="box-body">
						<div class="container-fluid">
							...
							<div class="row">
								<div class="mb-3 row">
									<label class="col-md-3 col-form-label text-end">Processing Branch</label>
									<div class="col-md-5">
					...
					<div class="box-body">
						<div class="container-fluid">
							...
							<div class="row">
								<div class="mb-3 row">
									<label class="col-md-3 col-form-label text-end">Transaction Description</label>
									<div class="col-md-5">
							...
							<div class="row">
								<div class="mb-3 row">
									<label class="col-md-3 col-form-label text-end">Destination Country</label>
									<div class="col-md-5">
							...
							<div class="row">
								<div class="mb-3 row">
									<label class="col-md-3 col-form-label text-end">Destination Bank</label>
									<div class="col-md-5">
							...
							<div class="row">
								<div class="mb-3 row">
									<label class="col-md-3 col-form-label text-end">Destination Account Number</label>
									<div class="col-md-5">
							...
							<div class="row">
								<div class="mb-3 row">
									<label class="col-md-3 col-form-label text-end">Identity</label>
									<div class="col-md-5">
...
<script>
	...
	function setInstructionMode(detail){
        ...
        if (instructionMode !=null && instructionMode == 'I') {
            ...
            /*tags += '<label class="col-md-3 col-form-label text-end">For</label>';
            tags += '<div class="col-md-5">';
            tags += '<label>'+confirm_data.payment_for+'</label>';
            tags += '</div>';
            tags += '<label class="col-md-3 col-form-label text-end">Every</label>';
            tags += '<div class="col-md-5">';
            ...
            tags += '<label>'+detail.sessionTime+'</label>';
            tags += '</div>';
            tags += '<label class="col-md-3 col-form-label text-end">End Date</label>';
            tags += '<div class="col-md-5">';
