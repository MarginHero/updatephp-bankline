                ...
                <form id="form-area" class="form-horizontal form-area">
                    <div class="box-body">
                        <div class="container-fluid">
                            ...
                            <div class="mb-3 row addState">
                                <div class="row">
                                    <div class="mb-3 row">
                                        <label class="col-md-4 col-form-label currlbl"><strong>Foreign Currency&ast;</strong></label>
                                        <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="mb-3 row">
                                        <label class="col-md-4 col-form-label lblMinBuy"><strong>Minimum Buy Limit in IDR&ast;</strong></label>
                                        <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="mb-3 row">
                                        <label class="col-md-4 col-form-label lblMaxBuy"><strong>Maximum Buy Limit in IDR&ast;</strong></label>
                                        <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="mb-3 row">
                                        <label class="col-md-4 col-form-label lblMinSell"><strong>Minimum Sell Limit in IDR&ast;</strong></label>
                                        <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="mb-3 row">
                                        <label class="col-md-4 col-form-label lblMaxSell"><strong>Maximum Sell Limit in IDR&ast;</strong></label>
                                        <div class="col-md-4">
