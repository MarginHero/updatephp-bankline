@include('_partials.header_content',['breadcrumb'=>['Pending task','Bank Forex Limit']])
                    ...
                    <h3 class="box-title addState">Bank Forex Limit Detail</h3><br>
                      ...
                      <div class="box-body">
                        ...
                        <div class="container-fluid addState">
                            <div class="row">
                                <div class="mb-3 row">
                                    <label class="col-md-2 col-form-label text-end">Foreign Currency</label>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="mb-3 row">
                                    <label class="col-md-2 col-form-label text-end">Minimum Buy Limit in IDR</label>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="mb-3 row">
                                    <label class="col-md-2 col-form-label text-end">Maximum Buy Limit in IDR</label>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="mb-3 row">
                                    <label class="col-md-2 col-form-label text-end">Minimum Sell Limit in IDR</label>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="mb-3 row">
                                    <label class="col-md-2 col-form-label text-end">Maximum Sell Limit in IDR</label>
                                    <div class="col-md-6">
