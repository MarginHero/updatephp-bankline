@include('_partials.header_content',['breadcrumb'=>['Pending task','Institution Category Detail']])
            ...
            <form class="form-horizontal">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Institution Category Code</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Institution Category Name</label>
                                <div class="col-md-6">
                                    <label id="name">-</label>
                                </div>
                            </div>
						...
						<div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Institution Category Name English</label>
                                <div class="col-md-6">
