    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="cancel" class="btn btn-default" data-bs-dismiss="modal">@lang('form.cancel')</button>
...
<script>
            ...
            "initComplete": function(settings, json) {
                ...
                $('#confirm').on('click', function () {
                    ...
                    $.confirm({
                        ...
                        content: 'Are you sure you want to unlock Serial Number '+$('#tokenNo-modal').text()+' from '+$('#name').val()+' ? Click “Confirm” to process or “Cancel” to cancel the submission.',
                        buttons: {
    ...
    function unblockAction(e){
        $.confirm({
            title: '{{trans('form.submit')}}',
            content: 'Are you sure you want to unblock Serial Number '+$(e).attr('data-tokenNo')+' from '+$('#name').val()+' ? Click “Confirm” to process or “Cancel” to cancel the submission.',
            buttons: {
    ...
    function unassignAction(e){
        $.confirm({
            title: '{{trans('form.submit')}}',
            content: 'Are you sure you want to unassign Serial Number '+$(e).attr('data-tokenNo')  +' from '+$('#name').val()+' ? Click “Confirm” to process or “Cancel” to cancel the submission.',
            buttons: {
