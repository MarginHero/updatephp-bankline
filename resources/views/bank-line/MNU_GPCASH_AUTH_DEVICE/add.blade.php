...
<style>
    ...
    .serial-number-inline .form-control {
        flex: 1;
    }
                        ...
                        <div class="mb-3 row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="serial-number-inline">
                                    <input type="text" class="form-control numeric" id="serialNo" name="serialNo" value="" maxlength="40" placeholder="Enter Serial Number">
                                    <button id="add_list" class="btn btn-primary btn-add-list" type="button">Add to List</button>
                                </div>
                            </div>
                        </div>
                    </div>
