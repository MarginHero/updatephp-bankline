            ...
            <!-- <div class="box">
					...
					<div class="container-fluid">
                        <div class="row">
							<div class="mb-3 row form-group">
								<label class="col-md-2 col-form-label text-end">Beneficiary Name</label>
								<div class="col-md-6">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-2 col-form-label text-end">Ordering Customer Name</label>
                                <div class="col-md-6">
						...
						<div class="row">
							<div class="mb-3 row form-group">
								<label class="col-md-2 col-form-label text-end">Remittance Information</label>
								<div class="col-md-6">
...
var createdByUserCode = '{{ $createdByUserCode }}';
    ...
    function getDetailData(data){
        ...
        var remittanceInfo = detail.remittanceInfo || '';
