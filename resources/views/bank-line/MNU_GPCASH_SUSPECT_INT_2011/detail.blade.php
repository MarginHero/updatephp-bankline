@include('_partials.header_content',['breadcrumb'=>['Suspect Remittance 1011','detail']])
                    ...
                    <div class="box-body" id="reason_box" style="display: none">
                       <div class="mb-3 row form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="reason_text_entry" maxlength="60"  name="reason_text_entry" class="form-control" autocomplete="off" value="" >
                    ...
                    <div class="box-footer">
                        <div class="state_view">
                            <div class="float-left">
                                ...
                                <button type="button" id="save_screen_done" name="save_screen_done" class="btn btn-default" style="display: none" onclick="savePdf();" >@lang('form.save_pdf')</button>
                            </div>
        ...
        $('#confirm').on('click', function () {
            ...
            if($('#reason_box').css('display') == 'none'){
                ...
                if (!$('#reason_text_entry').val()) {
                    $('.help-block.with-errors').text('Decline Reason is mandatory').show();
                    return;
                } else {
                    $('.help-block.with-errors').text('').hide();
            ...
            success: function (data) {
                ...
                if (resultArray.status=="200") {
                    ...
                    $.ajax({
                        ...
                        method: 'post',
                        data: {
                            viewURL : service + '.partial.' +  result.detail.menuCode
                        },
