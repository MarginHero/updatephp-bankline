@include('_partials.header_content',['breadcrumb'=>['Pending task','Prepaid Denomination Detail']])
            ...
            <form class="form-horizontal">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-2 col-form-label text-end">Package Code</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-2 col-form-label text-end">Denomianation Name</label>
                                <div class="col-md-6">
                                    <label id="name">-</label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-2 col-form-label text-end">Denomination</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-2 col-form-label text-end">Denomination Type</label>
                                <div class="col-md-6">
