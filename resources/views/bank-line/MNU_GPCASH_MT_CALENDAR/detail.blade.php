...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#delete').on('click', function () {
           ...
           // $('.state_delete').show();
            ...
            var nameType = today_event[0].type;
            var content ='{{trans('form.confirm_delete_type',['type'=>'$type'])}}';
            var content2 = content.replace('$type',nameType);
            $.confirm({
    ...
    function getMatrix(holidayDate,todayEvent){
        ...
        $('#edit').on('click', function () {
            ...
            if(res=='done'){
                $('#type').val('edit');
                $('#old_table').attr('data',JSON.stringify(todayEvent));
                getCurrency();
