    ...
    <div class="row">
        <div class="col-xs-12">
           ...
           <div class="box-header">
                ...
                <input type="hidden" id="old_table" value=""/>
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <label class="radio-inline state_edit" style="margin-left: 8px;margin-right: 8px;">
    ...
    $(document).ready(function () {
        ...
        function submitData(){
            ...
            if ($('#type').val() == 'add'){
                ...
                var oldHolidayList = JSON.parse($('#old_table').attr('data'));
                url = 'edit';
                url_action = "submitUpdate";
                value = {
                    "holidayDate": holiday_date,
                    "holidayList": holiday_list,
                    "oldHolidayList": oldHolidayList,
                    "action": 'UPDATE',
                    "loginId":loginId
