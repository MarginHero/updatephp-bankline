        ...
        <div class="panel-body box-body">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title text-uppercase">Import L/C Information</h3><br>
                    <hr>
                </div>
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <label id="bank_ref_no">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Issued Date</label>
                                <div class="col-md-6">
                                    <label id="issued_date">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Number of Amendment</label>
                                <div class="col-md-6">
                                    <label id="no_of_amendment">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Last Amendment Date</label>
                                <div class="col-md-6">
                                    <label id="last_amendment_date">-</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div id="text-amend_narrative" class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <label id="amend_narrative">-</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div id="text-file_upload1" class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFile('file_upload1');" id="file_upload1">-</a>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div id="text-file_upload2" class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"></label>
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFile('file_upload2');" id="file_upload2">-</a>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div id="text-file_upload3" class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"></label>
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFile('file_upload3');" id="file_upload3">-</a>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div id="text-file_upload4" class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"></label>
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFile('file_upload4');" id="file_upload4">-</a>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div id="text-file_upload5" class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"></label>
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFile('file_upload5');" id="file_upload5">-</a>
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box-header">
                    <h3 class="box-title text-uppercase">Bank Response</h3><br>
                    <hr>
                </div>
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Bank Reference No.</label>
                                <div class="col-md-6">
                                    <label id="bank_ref_no_res">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Issued Date</label>
                                <div class="col-md-6">
                                    <label id="issue_date">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Comment by Bank</label>
                                <div class="col-md-6">
                                    <label id="comment_by_bank">-</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div id="text-bank1" class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end">Bank Upload Document</label>
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFileBank('1');" id="fileNameBank1">-</a>
                                    </label>
                        ...
                        <div class="row">
                            <div id="text-bank2" class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"></label>
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFileBank('2');" id="fileNameBank2">-</a>
                                    </label>
                        ...
                        <div class="row">
                            <div id="text-bank3" class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"></label>
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFileBank('3');" id="fileNameBank3">-</a>
                                    </label>
                        ...
                        <div class="row">
                            <div id="text-bank4" class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"></label>
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFileBank('4');" id="fileNameBank4">-</a>
                                    </label>
                        ...
                        <div class="row">
                            <div id="text-bank5" class="mb-3 row">
                                <label class="col-md-4 col-form-label text-end"></label>
                                <div class="col-md-6">
                                    <label>
                                        <a onClick="downloadFileBank('5');" id="fileNameBank5">-</a>
                                    </label>
...
<script>
    ...
    function getDetailData(refNo){
        var value = {
            referenceNo : refNo,
            loginUserCode:createdByUserCode
        };
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == "200") {
                    ...
                    //LC Info
                    $('#trx_ref_no').text(detail.trxRefNo);
                    $('#bank_ref_no').text(detail.bankRefNo);
                    var issued_date = moment(detail.issuedDate, 'DD/MM/YYYY').format("DD-MMM-YYYY")
                    $('#issued_date').text(issued_date);
                    $('#no_of_amendment').text(detail.noOfAmend);

                    var last_amendment_date = moment(detail.lastAmendDate == undefined ? detail.lastAmendmentDate : detail.lastAmendDate, 'DD/MM/YYYY').format("DD-MMM-YYYY")
                    $('#last_amendment_date').text(detail.noOfAmend == '0' ? '-': last_amendment_date);
                    // General
                    ...
                    $('#lc_type').text(getlcType(detail.lcTypeCode));
                    $('#confirm_inst').text(detail.confirmInstructionCode);
                    $('#credit_avlb_by').text(getcreditAvailableCode(detail.creditAvailableCode));
                    $('#payment_draft_at').text(getpayDraftAtType(detail.payDraftAtType));

                    if (detail.payDraftAtType === 'SIGHT') {
                        $('#payment_draft_at1').hide();
                    }
                    var payment_draft_at1 = `${detail.payDraftAtDays} Days - ${detail.payDraftAtValue1 === 'AFTER' ? 'After' : 'From'} - ${getPayDraftAtValue2(detail.payDraftAtValue2)} ${detail.payDraftAtValue3 === '' ? '' : '-'} ${detail.payDraftAtValue3}`
                    ...
                    $('#amend_narrative').text(detail.amendmentNarrative);
                    $('#expiry_place').text(detail.expiryPlace);
                    $('#charge_by_bank').text(detail.issuingBankChargeBy === 'APP' ? 'Applicant' : 'Beneficiary');
                    $('#charge_by_confirm').text(detail.confirmingChargeBy === 'APP' ? 'Applicant' : 'Beneficiary');
                    $('#charge_by_outside').text(detail.outsideCountryChargeBy === 'APP' ? 'Applicant' : 'Beneficiary');
                    $('#charge_by_reimbursing').text(detail.reimburseBankChargeBy === 'APP' ? 'Applicant' : 'Beneficiary');
                    // Goods and Shipment
                    ...
                    $('#vol_of_goods').text(detail.volumeOfGoods);
                    ...
                    $('#amend_info').text(detail.amendOtherInfo);
                    ...
                    $('#action_status').text(detail.actionStatus);
                    $('#bank_ref_no_res').text(detail.bankReferenceNo);
                    var issue_date = moment(detail.issuedDate, 'DD/MM/YYYY').format("DD-MMM-YYYY")
                    $('#issue_date').text(issue_date);
                    $('#comment_by_bank').text(detail.bankComment);

                    $('#fileNameBank1').text(detail.fileNameBank1);
                    $('#fileNameBank2').text(detail.fileNameBank2);
                    $('#fileNameBank3').text(detail.fileNameBank3);
                    $('#fileNameBank4').text(detail.fileNameBank4);
                    $('#fileNameBank5').text(detail.fileNameBank5);

                    if (detail.fileNameBank1 == "" || detail.fileNameBank1 == null) { $('#text-bank1').hide(); }
                    if (detail.fileNameBank2 == "" || detail.fileNameBank2 == null) { $('#text-bank2').hide(); }
                    if (detail.fileNameBank3 == "" || detail.fileNameBank3 == null) { $('#text-bank3').hide(); }
                    if (detail.fileNameBank4 == "" || detail.fileNameBank4 == null) { $('#text-bank4').hide(); }
                    if (detail.fileNameBank5 == "" || detail.fileNameBank5 == null) { $('#text-bank5').hide(); }

                    $('#fileIdMain1').val(detail.fileIdBank1);
                    $('#fileIdMain2').val(detail.fileIdBank2);
                    $('#fileIdMain3').val(detail.fileIdBank3);
                    $('#fileIdMain4').val(detail.fileIdBank4);
                    $('#fileIdMain5').val(detail.fileIdBank5);
    ...
    function getpayDraftAtType(val) {
        var payDraftAtType = {
            'SIGHT': 'Sight Draft',
            'USANCE': 'Usance',
            'UPAS': 'Upas',
        }
        return payDraftAtType[val]
    }

    function getlcType(val) {
        var lcType = {
            'SKBDN': 'SKBDN/Local LC',
            'IRREV': 'Irrevocable LC',
        }
        return lcType[val]
    }
    ...
    function downloadFileBank(num) {

           var fileName = $('#fileNameBank'+num).text();
           var fileId = $('#fileIdMain'+num).val();
           var type = 'B';
