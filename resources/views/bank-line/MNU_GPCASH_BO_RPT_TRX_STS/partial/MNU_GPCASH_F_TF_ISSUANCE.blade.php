...
<section class="content">
    <div class="panel panel-default" style="border: 1px solid #ddd;  border-radius: 4px; box-shadow: 0 1px 1px rgba(0,0,0,0.1);">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == "200") {
                    ...
                    $('#credit_avlb_by').text(detail.creditAvailableCode);
                    ...
                    $('#incoterms1').text(detail.incotermName);
                    // Documents
