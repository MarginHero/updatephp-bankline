...
<!-- <section class="content">
    <div class="panel panel-default">
        <div class="panel-body box-body"> -->
            ...
            <input type="hidden" id="serviceCode" value=""/>
                <!-- <div class="box">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-5 col-form-label text-end">Beneficiary</label>
                                <div class="col-md-6">
                        ...
                        <div class="row localOverseasBankType" id="view_address1">
                            <div class="mb-3 row form-group">
                        ...
                        <div class="row localOverseasBankType" id="view_address2">
                            <div class="mb-3 row form-group">
                        ...
                        <div class="row localOverseasBankType" id="view_address3">
                            <div class="mb-3 row form-group">
                                <label class="col-md-5 col-form-label text-end"></label>
                                <div class="col-md-6">
                        ...
                        <div class="row localBankType">
                            <div class="mb-3 row form-group">
                                <label class="col-md-5 col-form-label text-end">Citizenship</label>
                                <div class="col-md-6">
                        ...
                        <!-- <div class="row overseasBankType">
                            <div class="mb-3 row form-group">
                                <label class="col-md-5 col-form-label text-end">Identity</label>
                                <div class="col-md-6">
                                    <label id="overseasIdentity">-</label>
                                </div>
                            </div>
                        </div> -->
                        <div class="row overseasBankType" id="view_transactor">
                            <div class="mb-3 row form-group">
                    ...
                    <div class="container-fluid overseasBankType">
                        ...
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-5 col-form-label text-end">Town Name</label>
                                <div class="col-md-6">
                                    <label id="overseasBankTownName">-</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    if (detail.stateView) {
                        ...
                        if (beneMenuType == 'Internal Bank') {
                            ...
                            if (beneMenuType == 'Overseas') {
                                ...
                                $('#overseasBankTownName').text(detail.overseas_bank_town_name != '' ? detail.overseas_bank_town_name : confirm_data.overseas_bank_town_name);
                    ...
                    $('#serviceCode').val(detail.transactionServiceCode);
