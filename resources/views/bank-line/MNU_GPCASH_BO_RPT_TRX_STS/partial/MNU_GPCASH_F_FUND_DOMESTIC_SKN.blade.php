                        ...
                        <div class="row" id="rateDiv" style="display:none">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label id="counterRate" style="padding-left: 3.5rem!important;"></label>
                                </div>
...
<script>
                ...
                if (result.status=="200") {
                    ...
                    if (detail.source_acct_ccy !== 'IDR') {
                        ...
                        if (detail.exchangeRate == 'CR') {
                            $('#exchangeRate').text(confirm_data.exchangeRate);
                            //$('#counterRate').text(currencyFormatRate(detail.counterRate));
							$('#counterRate').text(confirm_data.counterRate);
                        }
                        if (detail.exchangeRate == 'SR') {
                            $('#exchangeRate').text(confirm_data.exchangeRate);
                            //$('#specialRate').text(currencyFormatRate(detail.specialRate));
							$('#counterRate').text(confirm_data.specialRate);
                        }
                        $('.equivalentDiv').show();
    ...
    function currencyFormatRate(num) {
        return parseFloat(num).toFixed(6).replace(/(\d)(?=(\d{3})+(?!\d)(?=\.))/g, "$1,"); //<--- $1  is a special replacement pattern which holds a value of the first parenthesised submatch string
    }
