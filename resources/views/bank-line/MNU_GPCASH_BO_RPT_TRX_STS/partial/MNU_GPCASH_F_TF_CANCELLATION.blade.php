            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-4 col-form-label text-end">Increase</label>
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label" id="increase">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-4 col-form-label text-end">Decrease</label>
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label" id="decrease">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label" id="tolerance1">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <!-- <div class="row">
                        ...
                        <div class="row">
                            <div class="mb-3 row form-group">
                                <label class="col-md-4 col-form-label text-end">Amend Narrative</label>
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label" id="amend_narrative">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('file_upload1');" id="file_upload1">-</a>
                                    </label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('file_upload2');" id="file_upload2">-</a>
                                    </label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('file_upload3');" id="file_upload3">-</a>
                                    </label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('file_upload4');" id="file_upload4">-</a>
                                    </label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('file_upload5');" id="file_upload5">-</a>
                                    </label>
                                <!-- </div> -->
                            </div>
                        </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label" id="action_status">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label" id="bank_ref_no">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label" id="issue_date">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 row form-group">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label" id="comment_by_bank">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                    </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == "200") {
                    ...
                    var decrease = currencyFormat(detail.amountDecrease)
                    if (detail.amountDecrease == '') {
                        decrease = 0;
                    }
                    $('#decrease').text(decrease);
                    var increase = currencyFormat(detail.amountIncrease)
    ...
    function downloadFileBank(e) {
        var imageUrl, fileName
        if (e == 'fileBytes1') {
            imageUrl = fileImage1;
            fileName = $('#fileBytes1').text()
        } else if (e == 'fileBytes2') {
            imageUrl = fileImage2;
            fileName = $('#fileBytes2').text()
        } else if (e == 'fileBytes3') {
            imageUrl = fileImage3;
            fileName = $('#fileBytes3').text()
        } else if (e == 'fileBytes4') {
            imageUrl = fileImage4;
            fileName = $('#fileBytes4').text()
        } else if (e == 'fileBytes5') {
            imageUrl = fileImage5;
            fileName = $('#fileBytes5').text()
        }
