        ...
        $('#search').on('click', function (){
            ...
            if (validate) {
                    ...
                    $('.updateprev').on('click', function () {
                       ...
                       var content ='Are you sure you want to update introduction date to Previous Working Day? Click “Confirm” to process or “Cancel” to cancel the submission.';
                    ...
                    $('.updatenext').on('click', function () {
                       ...
                       var menu = $(this).attr('data-menu');
                       var refno = $(this).attr('data-refno');
                       var content ='Are you sure you want to update introduction date to Next Working Day? Click “Confirm” to process or “Cancel” to cancel the submission.';
