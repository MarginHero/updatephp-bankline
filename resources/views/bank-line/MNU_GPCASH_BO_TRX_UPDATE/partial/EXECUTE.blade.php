...
<script>
    ...
    function setChargesDetail(chargeList){
        ...
        for (var i = 0; i < chargeList.length; i++) {
            ...
            tags += '<label class="col-md-5 col-form-label text-end">Fee Equivalent Amount</label>';
            tags += '<div class="col-md-6"><label>'+chargeList[i].chargeCurrency+" "+currencyFormat(chargeList[i].chargeEquivalentAmount)+'</label></div>';
            tags += '<label class="col-md-5 col-form-label text-end">Fee Exchange Rate</label>';
