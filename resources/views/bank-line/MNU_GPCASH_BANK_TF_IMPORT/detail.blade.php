@include('_partials.header_content',['breadcrumb'=>['Import LC Search','detail']])
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="container-fluid" id="importDetail">
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label ">Transaction Reference No.</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label ">Corporate ID</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label ">Corporate name</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label ">Maker ID</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label ">Number of Returned</label>
                                <div class="col-md-6">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="tab-validation">
                            <div class="row">
                                <div class="mb-3 row">
                                    <label class="col-md-2 col-form-label "><b>Action Status*</b></label>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <!-- <div class="col-md-6 state_edit">
                                        <textarea id="validationComment" class="form-control" rows="3" maxlength="200" style="margin-top: 10px;" required></textarea>
                                    </div> -->
                                    <div class="col-md-6 state_edit">
                                        <textarea id="validationComment" class="form-control" maxlength="200" style="min-height: 120px;" required></textarea>
                                    </div>
                                    <div class="col-md-6 state_view">
                                        <label id="validationComment_view" style="white-space: pre-wrap;">-</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tab-update">
                            <form id="form-area1" class="form-horizontal form-area1">
                                ...
                                <div class="row">
                                    <div class="mb-3 row">
                                        <label class="col-md-2 col-form-label "><b>Bank Reference No*</b></label>
                                        <div class="col-md-6 state_edit">
                                ...
                                <div class="row">
                                    <div class="mb-3 row">
                                        <label class="col-md-2 col-form-label "><b>Issue Date*</b></label>
                                        <div class="col-md-6 state_edit">
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                <input type="text" id="issueDate" name="issueDate" class="form-control datepicker detail numeric" autocomplete="off" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-6 state_view">
                                            <label id="issueDate_view">-</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 row">
                                        <label class="col-md-2 col-form-label ">Comment</label>
                                        <!-- <div class="col-md-6 state_edit">
                                            <textarea id="updateStatusComment" class="form-control" rows="3" maxlength="200" style="margin-top: 10px;" required></textarea>
                                        </div> -->
                                        <div class="col-md-6 state_edit">
                                            <textarea id="updateStatusComment" class="form-control" maxlength="200" style="min-height: 120px;" required></textarea>
                                        </div>
                                        <div class="col-md-6 state_view">
                                            <label id="updateStatusComment_view" style="white-space: pre-wrap;">-</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 row">
                                        <label class="col-md-2 col-form-label ">Upload Documents</label>
                                        <div class="col-md-6 state_edit">
...
<script>
    ...
    $(document).ready(function () {
        ...
        function submitData(){
            ...
            var importDetail = {};
            var importChild = document.querySelectorAll("#importDetail label"); //get all label value from Id '#importDetail'
            for (var i = 0; i<importChild.length; i++) {
                if (importChild[i].id) {
                     // console.log("============= ", importChild[i].id);
                     // console.log("============= ", $('#'+(importChild[i].id)).text());
                     importDetail[importChild[i].id] = $('#'+(importChild[i].id)).text(); //put all id value to importDetail
                }

            }

            var detailTransaction = {};
            var trxChild = document.querySelectorAll("#detailTransaction label"); //get all label value from Id '#detailTransaction'
            for (var i = 0; i<trxChild.length; i++) {
                if (trxChild[i].id) {
                     detailTransaction[trxChild[i].id] = $('#'+(trxChild[i].id)).text(); //put all id value to detailTransaction
                }
            }
            ...
            for (var i = 1; i < 6; i++) {
                //file_upload1
                if ($('#file_upload'+i) !=='') {
                    trxUploadFile['detailUpload'+i] = $('#file_upload'+i).text();
                    trxUploadFile['fileIdTrx'+i] = getFileId(i);
                }

            }

            value['importDetail'] = importDetail;
            value['detailTransaction'] = detailTransaction;
            value['trxUploadFile'] = trxUploadFile;
    ...
    function stateView(){
        ...
        if (tabActive === '#tab_validation') {
            ...
            var issueDate = ($('#issueDate').val() == '' ? '-' : $('#issueDate').val());
