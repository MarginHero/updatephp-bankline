@include('_partials.header_content',['breadcrumb'=>['Cancellation LC','detail']])
...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <input type="hidden" id="trxRefNo" value=""/>
            <input type="hidden" id="bankRefNo" value=""/>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6 state_edit">
                                    <textarea id="validationComment" class="form-control" maxlength="255" style="min-height: 120px;" required></textarea>
                                </div>
                                <div class="col-md-6 state_view">
                        ...
                        <!-- <div class="row state_view">
                            <div class="mb-3 row">
                                <div class="col-md-2 state_view"></div>
                                    <div class="col-md-6 state_view">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-3 col-form-label" id="payment_draft_at">-</label>&nbsp;<label class="col-md-3 col-form-label" id="payment_draft_at1">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="mb-3 row">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('1', 'detail');" id="file_upload1">-</a>
                                    </label>
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('2', 'detail');" id="file_upload2">-</a>
                                    </label>
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('3', 'detail');" id="file_upload3">-</a>
                                    </label>
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('4', 'detail');" id="file_upload4">-</a>
                                    </label>
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label">
                                        <a class="link-primary" onClick="downloadFile('5', 'detail');" id="file_upload5">-</a>
                                    </label>
                ...
                <div class="box-header">
                    <h3 class="box-title text-uppercase">Cancellation L/C Information</h3><br>
                    <hr>
                </div>
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <label class="col-md-6 col-form-label" id="cancelReason">-</label>
                                <!-- </div> -->
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <div class="me-auto">
                    <button type="button" id="print" name="print" class="btn btn-primary" data-dismiss="modal">Print</button>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        function submitData() {
            ...
            value = {
                ...
                bankComment: $('#validationComment').val(),
    ...
    function getDetail(){
        ...
        var url_action= 'searchCancellationLC';
        var value ={
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status == "200") {
                    ...
                    $('#cancelReason').text(detail.cancelReason);
