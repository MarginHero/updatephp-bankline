                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6 row-corporate">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#branch").on('change', function() {
            var value = $(this).val();
            if (value == '') {
                $("#corporate").val("").trigger('change.select2');
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    unitOption = '<option value="" selected>All Branch</option>';
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $.each(result.result, function (idx, obj) {
                        unitOption += '<option value="' + obj.corporateId + '">' + obj.corporateId + ' - ' + obj.name + '</option>';
                    });
    ...
    function getStatusDroplist() {
        ...
        $.ajax({
            ...
            success: function (data) {
                var result = JSON.parse(data);
                if (result.status=="200") {
                    unitOption = '<option value="" selected>All Status</option>';
                    $.each(result.statusList, function (idx, obj) {
                        unitOption += '<option value="' + obj.code + '">' + obj.text + '</option>';
                    });
    ...
    function requestDownload(fileFormat) {
        ...
        if ($("#corporate").val() == '' || $("#corporate").val() == 'Select Company') {
            validate = false;
