           ...
           <div class="box-header">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end"><strong>Deposit Code&ast;</strong></label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end"><strong>Deposit Name&ast;</strong></label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end"><strong>Tax Deposit Type Code&ast;</strong></label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end"><strong>Tax Type&ast;</strong></label>
                                <div class="col-md-4">
