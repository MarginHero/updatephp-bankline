@include('_partials.header_content',['breadcrumb'=>['Pending task','Deposit Detail']])
            ...
            <form class="form-horizontal">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end">Deposit Code</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end">Deposit Name</label>
                                <div class="col-md-6">
                                    <label id="name">-</label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end">Tax Deposit Type Code</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end">Tax Type</label>
                                <div class="col-md-6">
