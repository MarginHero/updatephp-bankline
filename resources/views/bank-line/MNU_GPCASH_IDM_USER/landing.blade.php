        ...
        oTable = $('#list').DataTable({
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    width: "30%",
                    render: function ( data, type, full, meta ) {
                        return full.branchCode+' - '+full.branchName;
                    },
                    orderable: true
                },
                {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    unitOption = '<option value=""> All Unit </option>';
                    ...
                    if (window.searchParam) {
                        ...
                        $('#branchCode').val(window.searchParam.branchCode).change();
