                            ...
                            <div class="row">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-5 row-corporate">
                                        <select class="form-control" id="corporate" required>
...
<script>
    ...
    function getAccountType() {
		var menu = '{{ $service }}';
        var value = {};
        var url_action = 'searchAccountType';
        var action = 'SEARCH';
        var menu = menu;
        $.ajax({
            url: 'getAPIData',
            ...
            success: function (data) {
                var result = JSON.parse(data);
                if (result.status=="200") {
                    unitOption = '<option value="">All Account Type</option>';
                    $.each(result.result, function (idx, obj) {
    ...
    function requestDownload(fileFormat) {
        ...
        if (value.corporateId == '' || value.corporateId == 'Select Company') {
        ...
        value.accountType = $("#activityType").val();
