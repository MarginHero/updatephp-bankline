                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-3">
                                   ...
                                   <label for="updateAll-rb" class="col-form-label text-end">Update All Limit Setup</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-3 specificLimitRow" >
...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                   ...
                   /* var groupedData = result.result.map((current) => ({
 			...
 			currencySelect += '<option value="IDR">IDR</option>';
    ...
    function getTableData() {
        ...
        $("#list").find("tbody tr").each(function () {
            ...
            if (check == 1|| serviceCode == service_codeTemp) {
                service_codeTemp = serviceCode;
                data.push(obj);
            }
        });
