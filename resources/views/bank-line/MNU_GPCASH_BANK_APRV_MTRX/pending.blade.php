@include('_partials.header_content',['breadcrumb'=>['Pending task','Approval Mechanism Detail']])
            ...
            <form class="form-horizontal">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end">Bank Approval Matrix Menu</label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end">Number of Approver</label>
                                <div class="col-md-6">
