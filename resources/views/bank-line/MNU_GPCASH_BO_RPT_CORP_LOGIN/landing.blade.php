                ...
                <div class="box-body">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <div class="col-md-3">
                                   <label for="corporate-rb"><strong>User ID</strong></label>
                                </div>
                                <div class="col-md-5 row-userid">
                                    <select class="form-control" id="activityBy">
                                        <option value="">All User ID</option>
                                    </select>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#corporate').on('change', function() {
            if($(this).val() != '' && $(this).val() != 'All Company') {
        ...
        $("#corporate").on('change', function() {
            ...
            if (value == '') {
                $('#activityBy').prop("disabled",true);
                $('#activityBy').html('<option value="" selected>All User ID</option>');
                return;
            }

            $('#activityBy').prop("disabled",false);
            getActivityByDroplist(value);
        });
    ...
    function getActivityByDroplist(corpId) {
        ...
        $.ajax({
            ...
            success: function (data) {
                var result = JSON.parse(data);
                if (result.status=="200") {
					unitOption = '<option value="" selected>All User ID</option>';
                    $.each(result.result, function (idx, obj) {
