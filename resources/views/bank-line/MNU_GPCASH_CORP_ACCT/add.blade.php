                ...
                if (result.status=="200") {
                    ...
                    $.each(detail, function (idx, obj){
                        ...
                        oTable_add.row.add([
                            ...
                            obj.accountTypeName+'<input type=hidden id="accountTypeName" value="'+obj.accountTypeName+'">'+'<input type=hidden id="accountTypeCode" value="'+obj.accountTypeCode+'">'+'<input type=hidden id="accountBranchCode" value="'+obj.accountBranchCode+'">'+'<input type=hidden id="accountTypeHostCode" value="'+obj.accountTypeHostCode+'">',
                            obj.isAllowInquiry,
                            obj.isAllowDebit,
                            obj.isAllowCredit,
                            obj.accountStatus
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    oTable_add.row.add([
                        ...
                        result.accountTypeName+'<input type=hidden id="accountTypeName" value="'+result.accountTypeName+'">'+'<input type=hidden id="accountTypeCode" value="'+result.accountTypeCode+'">'+'<input type=hidden id="accountBranchCode" value="'+result.accountBranchCode+'">'+'<input type=hidden id="accountTypeHostCode" value="'+result.accountTypeHostCode+'">',
       ...
       /* $("#list").find("tbody tr").each(function () {
        ...
        function getTableData() {
            ...
            $(dataTable.fnGetNodes()).each(function(){
                ...
                var accountTypeHostCode = $('td:eq(3)', $(this)).find('#accountTypeHostCode').val();
                ...
                var obj = {
                    ...
                    accountTypeHostCode:accountTypeHostCode,
