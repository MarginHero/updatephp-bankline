        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $('#fee_setup').text(detail.chargePackageCode + ' - '+ detail.chargePackageName);
                    $('#limit_setup').text(detail.limitPackageCode + ' - '+ detail.limitPackageName);
                    $('#menu_setup').text(detail.menuPackageCode + ' - '+ detail.menuPackageName);
                } else {
                    flash('warning', result.message);
                }
