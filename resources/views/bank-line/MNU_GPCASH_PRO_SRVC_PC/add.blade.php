    ...
    function getLimitDropList() {
        ...
        $.ajax({
            ...
            success: function (data) {
                var result = JSON.parse(data);
                if (result.status=="200") {
                    limitOption = '<select id="limit_list" class="form-control state_edit" data-error="Please select an item in the list." required>';
    ...
    function getFeeDropList() {
        ...
        $.ajax({
            ...
            success: function (data) {
                var result = JSON.parse(data);
                if (result.status=="200") {
                    feeOption = '<select id="fee_list" class="form-control state_edit" data-error="Please select an item in the list." required>';
    ...
    function getMenuDropList() {
        ...
        $.ajax({
            ...
            success: function (data) {
                var result = JSON.parse(data);
                if (result.status=="200") {
                    menuOption = '<select id="menu_list" class="form-control state_edit" data-error="Please select an item in the list." required>';
