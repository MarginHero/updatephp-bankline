                 ...
                 "buttons": [{
                     ...
                     action: function ( e, dt, node, config ) {
                         $.confirm({
                             ...
                             content: 'Are you sure you want to process all users for session release ? Click “Confirm” to process or “Cancel” to cancel the submission.',
                             buttons: {
                ...
                if (window.searchParam) {
                    ...
                    $('#code').val(window.searchParam.code).change();
                     $('#corporate_code').val(window.searchParam.corporateId).change();
                      $('#stillLoginFlag').text(window.searchParam.stillLoginFlag).change();
