                ...
                <div id="exTab" class="">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="scheduler-tab" data-bs-toggle="tab" data-bs-target="#tab_scheduler" type="button" role="tab" aria-controls="tab_scheduler" aria-selected="true">Scheduler</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="status-tab" data-bs-toggle="tab" data-bs-target="#tab_status" type="button" role="tab" aria-controls="tab_status" aria-selected="false">Status</button>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab_scheduler" role="tabpanel" aria-labelledby="scheduler-tab">
