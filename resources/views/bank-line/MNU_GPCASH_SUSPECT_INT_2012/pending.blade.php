@include('_partials.header_content',['breadcrumb'=>['Pending task','Suspect Remittance 2012']])
                ...
                <div class="box-body">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="box-body" id="reason_form_box" style="display: none;">
                            <div class="row">
                                <div class="mb-3 row">
                                    <label class="col-md-2 col-form-label text-end">Reason Decline</label>
                                    <div class="col-md-6">
            ...
            success: function (data) {
                ...
                if (resultArray.status=="200") {
                    ...
                    $.ajax({
                        ...
                        method: 'post',
                        data: {
                            viewURL : id + '.partial.' +  menuCodeDetail
                        },
