            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="container-fluid">
						<div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end">Parameter</label>
                                <div class="col-md-6">
            ...
            success: function (data) {
                ...
                if (result.status=="200") {
                    ...
                    $.each(result.result, function (idx, obj) {
                        const parseName = obj.name === 'Transaction Purpose BI fast' ? 'Transaction Purpose BI FAST' : obj.name;
                        unitOption += '<option value="'+ obj.code +'"data-name = "'+parseName+'"data-parentModelCode="'+ obj.parentModelCode+'" data-parentLabel="'+obj.parentLabel+'">'+ parseName + '</option>';
                    });
                    ...
                    if (window.searchParam) {
                        ...
                        $('#modelCode').val(window.searchParam.modelCode).change();
