                ...
                if (result.status=="200") {
                    ...
                    $.each(detail, function (idx, obj){
                        ...
                        oTable.row.add([
                            ...
                            '<span id="currency_matrix_name">'+obj.currencyMatrixName +'</span>'+'<input id="currencyMatrixName" name="service_code" class="form-control state_edit" value="' + obj.currencyMatrixName + '" type="hidden">'+'<input id="matrix_id" name="matrix_id" class="form-control state_edit" value="' + obj.id + '" type="hidden">',
                        ...
                        if(lastServiceName==obj.serviceName){
                                    $('#matrix_id[value="'+obj.id+'"]').parent().prev().prev().children().css('opacity','0')
                                }
