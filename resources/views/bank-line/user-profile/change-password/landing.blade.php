            ...
            <div id="print" class="box">
                ...
                <div class="box-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end"><strong>Current Password*</strong></label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end"><strong>New Password*</strong></label>
                                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="mb-3 row">
                                <label class="col-md-2 col-form-label text-end"><strong>Confirm New Password*</strong></label>
                                <div class="col-md-6">
